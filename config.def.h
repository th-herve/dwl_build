...
static const float rootcolor[]             = COLOR(0xfab387ff);
...
static const Key keys[] = {
	...
	{ MODKEY,                    XKB_KEY_y,          setlayout,      {0} },
	{ MODKEY,                    XKB_KEY_m,          togglelayout,   {0} },
	// { MODKEY,                    XKB_KEY_space,      setlayout,      {0} }, // toggle last two layouts
